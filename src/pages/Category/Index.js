        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            ...
            <Box component="div" sx={{border:"1px solid #fff0f0",borderRadius:"10px", width:"100%",padding:"10px 20px",bgcolor:"#F7F7F7"}}>
                ...
                <Typography component="p" color="#000" fontSize="12px"  textAlign="center" ><span>Deals </span><strong> 100</strong> <span> Coupons </span><strong> 100</strong></Typography>
                </Box>
                <Box sx={{textAlign:"center", p:1}}>
                  <Button variant="outlined"><Link to={`/category-detail/${1}`} style={{color:"#f27935"}}>View Deals</Link ></Button>
                </Box>
            </Box>
          </Grid>
         </Grid>
