...
import enterOtpImage from '../../../assets/images/enter-otp.png'
  ...
  return (
    <div style={{paddingTop:"56px"}}>
        <Box component="div" style={{width:"100%"}}>
            <img src={enterOtpImage} alt='LogIn ' style={{width:"100%"}}></img>
        </Box>
        <Box component="div" style={{width:"100%", padding:" 5px 20px"}}>
            ...
            <Typography variant="body1" component="p"><strong>{sendMobileNumber}</strong></Typography>
             ...
             <OTPInput
               ...
               <Button variant="contained" sx={{width:"100%", color:"#fff", fontWeight:"bold", margin:"20px 0",letterSpacing:"1px",fontSize:"17px"}} type='submit'>Submit</Button>
             </form>
        </Box>
