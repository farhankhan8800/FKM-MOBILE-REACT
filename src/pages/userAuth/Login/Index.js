        ...
        <Box component="div" style={{width:"100%", padding:" 5px 20px"}}>
            ...
            <TextField 
              ...
              variant="outlined" />
               ...
               <Button variant="contained" sx={{width:"100%", color:"#fff", fontWeight:"bold", margin:"10px 0",fontSize:"17px",letterSpacing:"1px"}} type='submit'>LogIn</Button>
               {
             ...
             <Box component="div" sx={{ p: 1,}}>
              <Button  variant="contained" sx={{width:"100%", bgcolor:"#f2793552", marginBottom:"15px"}} > <Link to="/" style={{color:"#000",textDecoration:"none",display:"flex",alignItems:"center",justifyContent:"center"}}><img  style={{height:"20px",width:"20px",marginRight:"10px"}} src={googleImage} alt='Google'></img> <span>Login With Google</span></Link>  </Button>
              <Button variant="contained" sx={{width:"100%", bgcolor:"#f2793552",marginBottom:"15px" }} > <Link to="/" style={{color:"#000",textDecoration:"none",display:"flex",alignItems:"center",justifyContent:"center"}}><img  style={{height:"20px",width:"20px",marginRight:"10px"}} src={facebookImage} alt='Google'></img> <span>Login With Facebook</span></Link>  </Button>
             </Box>
             <Box component="div" sx={{ p: 1,}}>
